...
class ActionsWidget(MainWidget,QWidget):
    ...
    def OpenRecipe(self):
        filePath=''
        filePath,extension =  QFileDialog.getOpenFileName (None,'Recipe File',self.WORKING_DIR,("Recipe Files (*.RCP);;Subrecipe Files (*.uRCP)"))
        if filePath !='':
    ...
    def SaveRecipe(self):
        try:
            ...
            path,extension = QFileDialog.getSaveFileName (None,'Recipe Name',self.WORKING_DIR+'\\'+defaultName,("Subrecipe Files (*.uRCP);;Recipe Files (*.RCP)"))
